...
export const domManager = (function () {
  ...
  closeFormButtons.forEach((closeFormButton) =>
  ...
  function loadEditFormProjectOptions() {
    const projectSelectOptions = document.querySelector(
  ...
  function renderTasks() {
    ...
    for (let i = 0; i < allTasks.length; i++) {
      ...
      taskNode.innerHTML = `<div class="task-node" data-task-id="${taskId}">
  ...
  function renderProjects() {
    ...
    for (let i = 0; i < allProjects.length; i++) {
      ...
      projectTitle.innerHTML = `<div class="project-block-title" data-project-id="${projectId}">
      ...
      for (let j = 0; j < allProjects[i].projectTasks.length; j++) {
        ...
        taskNode.innerHTML = `<div class="project-task-node">
  ...
  function setTaskStatus(taskId) {
    const taskStatus = document.querySelector(
      `[data-task-id="${taskId}"] .task-status`,
    );
    for (let i = 0; i < allTasks.length; i++) {
  ...
  function openProject(projectId) {
    ...
    const projectTitle = document.createElement("div");
    projectBlock.classList.add("project-block");
    projectTitle.innerHTML = `<div class="project-block-title">
    ...
    for (let i = 0; i < allProjects[projectIndex].projectTasks.length; i++) {
      ...
      if (allProjects[projectIndex].projectTasks[i].priority === "High") {
        ...
        allProjects[projectIndex].projectTasks[i].priority === "Medium"
      ) {
        taskNode.style.backgroundColor = "rgb(255, 238, 0)";
